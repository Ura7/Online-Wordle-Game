...
class SixLetterGameScreen : AppCompatActivity() {
    private lateinit var auth: FirebaseAuth
    private lateinit var binding: ActivitySixLetterGameScreenBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        binding = ActivitySixLetterGameScreenBinding.inflate(layoutInflater)
        ...
        auth = Firebase.auth
        val odabul = database.child("Oyun Kanalı 1").child("Channel 2").child("rooms")
...
//
                            ...
                            val intent = Intent(this@SixLetterGameScreen, Channel2::class.java)
...
//
                ...
                oda1.addValueEventListener(object : ValueEventListener {
                    override fun onDataChange(snapshot: DataSnapshot) {
                        if (snapshot.child("fplayerReady")
                            ...
                            val intent =
                                Intent(this@SixLetterGameScreen, SixLetterGameScreen::class.java)
                            startActivity(intent)
                            finish()
    ...
    private fun checkField():Boolean{
        ...
        {
            binding.wordtextinput.error="6 harfli bir kelime giriniz"
            return false
        }
    ...
    private fun timerCountdownfp(){
        timerf = object : CountDownTimer(60_000,1_000){
            ...
            override fun onFinish() {
                Toast.makeText(this@SixLetterGameScreen, "Süre bitti", Toast.LENGTH_SHORT).show()
                end()
            }
