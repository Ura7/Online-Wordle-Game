...
class Channel3 : AppCompatActivity() {
...
//      database.child("Oyun Kanalı 1").child(channelName.toString()).setValue(Channel(id, rooms))
                ...
                roomid.addListenerForSingleValueEvent(object : ValueEventListener {
                    override fun onDataChange(snapshot: DataSnapshot) {
                        ...
                        if(fplayerid=="empty")
                        {
                            ...
                            val intent = Intent(this@Channel3,FiveLetterSabitGameScreen::class.java)
                        ...
                        else if(fplayerid!="empty" && splayerid=="empty")
                        {
                            ...
                            {
                                Toast.makeText(this@Channel3,"Zaten Odadasın!", Toast.LENGTH_LONG).show()
                            }

                        }
                        else if(fplayerid!="empty" && splayerid!="empty")
                        {
                            Toast.makeText(this@Channel3,"Oda Dolu", Toast.LENGTH_LONG).show()
                        }
        ...
        binding.exitroomButton.setOnClickListener {
            ...
            if(currentUser!=null)
            {
                ...
                val intent = Intent(this@Channel3,GameLobby::class.java)
                startActivity(intent)
                finish()
